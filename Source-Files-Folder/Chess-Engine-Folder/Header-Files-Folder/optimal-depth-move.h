...
bool choose_timing_move(Move* move, signed short* score, const Piece board[], Info info, short depth, int playerSign, long startClock, short seconds, const Move moveArray[], int moveAmount);
