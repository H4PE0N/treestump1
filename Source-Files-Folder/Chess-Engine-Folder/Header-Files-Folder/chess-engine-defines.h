...
#define ALLOC_MOVE_FLAG(MOVE, FLAG)       ( (MOVE & ~MOVE_FLAG_MASK) | FLAG)
#define ALLOC_MOVE_STOP(MOVE, STOP)       ( (MOVE & ~MOVE_STOP_MASK) | STOP)
#define ALLOC_MOVE_START(MOVE, START)     ( (MOVE & ~MOVE_START_MASK) | START)

#define ALLOC_INFO_TEAM(INFO, TEAM)       ( (INFO & ~INFO_TEAM_MASK) | TEAM)
#define ALLOC_INFO_PASSANT(INFO, PASSANT) ( (INFO & ~INFO_PASSANT_MASK) | PASSANT)
#define ALLOC_INFO_TURNS(INFO, TURNS)     ( (INFO & ~INFO_TURNS_MASK) | TURNS)
#define ALLOC_INFO_COUNTER(INFO, COUNTER) ( (INFO & ~INFO_COUNTER_MASK) | COUNTER)

#define ALLOC_POINT_RANK(POINT, RANK)     ( (POINT & ~POINT_RANK_MASK) | RANK)
#define ALLOC_POINT_FILE(POINT, FILE)     ( (POINT & ~POINT_FILE_MASK) | FILE)
