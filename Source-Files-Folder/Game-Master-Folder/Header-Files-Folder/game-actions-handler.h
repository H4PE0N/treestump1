...
bool screen_computer_handler(Piece*, Info*, Move*, Screen);

bool screen_single_game(Piece*, Info*, Move*, Screen, bool*, bool);

bool screen_cheat_handler(Piece*, Info*, Move*, Screen, bool*);

bool screen_cheat_game(Piece*, Info*, Move*, Screen, bool*);

bool screen_multi_game(Piece*, Info*, Move*, Screen, bool*);

bool game_result_handler(Screen, const Piece[], Info, bool*);
