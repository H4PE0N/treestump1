...
#define BOARD_POINT_EXISTS(BOARD, POINT) CHESS_PIECE_EXISTS(BOARD[POINT])

#define BOARD_POINTS_TEAM(BOARD, POINT1, POINT2) CHESS_PIECES_TEAM(BOARD[POINT1], BOARD[POINT2])
#define BOARD_POINTS_ENEMY(BOARD, POINT1, POINT2) CHESS_PIECES_ENEMY(BOARD[POINT1], BOARD[POINT2])
