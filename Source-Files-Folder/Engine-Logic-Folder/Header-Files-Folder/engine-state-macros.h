...
#define STATE_CASTLES_MACRO(STATE) (MASK_STATE_CASTLES(STATE) >> STATE_CASTLES_SHIFT)
...
#define STATE_WINNING_TEAM(STATE) NORMAL_TEAM_ENEMY(STATE_CURRENT_MACRO(STATE))
